...
<div class="flex h-full min-h-screen">
    ...
    <nav id="sidebar" class="sidebar w-56 shrink-0 bg-slate-900 flex flex-col">
        ...
        $navItems = [
            ...
            '/agreements' => ['label' => 'Agreements', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
            '/email'      => ['label' => 'Email',      'icon' => 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8m-18 8V6a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2z'],
            '/renewals'   => ['label' => 'Renewals',   'icon' => 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15'],
